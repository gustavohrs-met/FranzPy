...
TEXT_DICT = {
    'pt': {
        ...
        'app_title': "FranzPy: An open-source Python tool to calculate and analyze data from Franz cell experiments.",
        'sidebar_nav': "Navegação",
        
        # --- Home Texts ---
        # Título principal na página
        'home_title': "FranzPy: An open-source Python tool to calculate and analyze data from Franz cell experiments.",
...
def main():
    ...
    if st.session_state.app_mode == 'home':
        ...
        st.title(f"FranzPy - {T['home_release_button']}")
        render_release_app() 
    elif st.session_state.app_mode == 'permeation':
        st.title(f"FranzPy - {T['home_permeation_button']}")
