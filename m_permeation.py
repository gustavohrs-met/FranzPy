...
TEXT_DICT = {
    'pt': {
        ...
        'perm_step3_info': r"Visualize o perfil de permeação acumulada (Média $\pm$ SD) de todos os grupos. Use este gráfico para identificar a região de Steady-State (linear) que será usada na próxima etapa.",
        'step3_color_picker_label': "Personalizar Cores",
        'step3_color_picker_group': "Cor para",
        'step3_xaxis_label': "Tempo (horas)",
        'step3_title_compare': r"Comparação dos Perfis de Permeação (Média $\pm$ SD)",
    ...
    'en': {
        ...
        'perm_step3_info': r"Visualize the cumulative permeation profile (Mean $\pm$ SD) of all groups. Use this plot to identify the Steady-State (linear) region, which will be used in the next step.",
        'step3_color_picker_label': "Customize Colors",
        'step3_color_picker_group': "Color for",
        'step3_xaxis_label': "Time (hours)",
        'step3_title_compare': r"Comparison of Permeation Profiles (Mean $\pm$ SD)",
...
def render_perm_step3(T):
    ...
    # CORREÇÃO: Substitui width='stretch' por width='stretch' e usa config
